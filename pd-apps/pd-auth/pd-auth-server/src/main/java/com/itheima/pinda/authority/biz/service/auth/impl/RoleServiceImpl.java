...
public class RoleServiceImpl extends ServiceImpl<RoleMapper, Role> implements RoleService {
    ...
    public void saveRole(RoleSaveDTO data, Long userId) {
        Role role = roleDtoConverter.roleSave2Dto(data);
    ...
    public void updateRole(RoleUpdateDTO data, Long userId) {
        Role role = roleDtoConverter.roleUpdate2Dto(data);
    ...
    private final void saveRoleOrg(Long userId, Role role, List<Long> orgList) {
