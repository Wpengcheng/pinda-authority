...
import com.itheima.pinda.authority.biz.converter.ResourseDtoConverter;
...
public class ResourceController extends BaseController {
    ...
    private final ResourseDtoConverter resourseDtoConverter;
    ...
    public R<Resource> save(@RequestBody @Validated ResourceSaveDTO data) {
        Resource resource = resourseDtoConverter.resourceSave2Dto(data);
    ...
    public R<Resource> update(@RequestBody @Validated(SuperEntity.Update.class) ResourceUpdateDTO data) {
        Resource resource = resourseDtoConverter.resourceUpdate2Dto(data);
    ...
    public R<List> list() {
        ...
        List<String> resourceList = list.stream().map(r -> r.getMethod() + r.getUrl()).collect(Collectors.toList());
