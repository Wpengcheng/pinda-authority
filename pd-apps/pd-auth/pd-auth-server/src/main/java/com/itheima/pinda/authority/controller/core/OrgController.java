...
import com.itheima.pinda.authority.biz.converter.OrgDtoConverter;
...
public class OrgController extends BaseController {
    ...
    private final OrgDtoConverter orgDtoConverter;
    ...
    public R<Org> save(@RequestBody @Validated OrgSaveDTO data) {
        Org org = orgDtoConverter.orgSave2Dto(data);
    ...
    public R<Org> update(@RequestBody @Validated(SuperEntity.Update.class) OrgUpdateDTO data) {
        Org org = orgDtoConverter.orgUpdate2Dto(data);
    ...
    public R<List<OrgTreeDTO>> tree(@RequestParam(value = "name", required = false) String name,
        ...
        List<Org> list = orgService.list(Wraps.<Org>lbQ()
                                             .like(Org::getName, name)
                                             .eq(Org::getStatus, status)
                                             .orderByAsc(Org::getSortValue));
        //List<OrgTreeDTO> treeList = orgDtoConverter.orgList2Dto(list);
